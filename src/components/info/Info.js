...
function info() {
    return (
        <>
            <section className='grid md:flex-row flex-col  gap-5 md:gap-5  grid-cols-12 mt-5 bg-slate-100 p-10 rounded shadow-lg  '>
                <div className='flex flex-col  text-indigo-600 col-span-12 md:col-span-4'>
                    <FontAwesomeIcon className=" text-2xl" icon={faEuroSign} />
                    <p className='font-semibold px-16 text-center md:px-0  text-indigo-500'>
            ...
            <section className='mt-10 grid grid-cols-12 gap-5'>
                <figure class="md:flex group bg-slate-100 col-span-12 md:col-span-4 rounded-xl p-8 md:p-0 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
                    <div class="pt-6 md:p-8 text-center md:text-left space-y-4">
                        <blockquote>
                            <p class="text-lg font-medium group-hover:text-white ">
                ...
                <figure class="group md:flex bg-slate-100 col-span-12 md:col-span-4 rounded-xl p-8 md:p-0  hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
                    <div class="pt-6 md:p-8 text-center md:text-left space-y-4">
                        <blockquote>
                            <p class="text-lg font-medium group-hover:text-white">
