...
function info() {
    return (
        <>
            <section className='grid md:flex-row flex-col  gap-5 md:gap-5  grid-cols-12 mt-5 bg-slate-100 dark:bg-slate-800 p-10 rounded shadow-lg  '>
                ...
                <figure className="md:flex group bg-slate-100 dark:bg-slate-800 dark:hover:border border border-transparent dark:hover:border-indigo-600  col-span-12 md:col-span-4 rounded-xl p-8 md:p-0  hover:bg-indigo-500 duration-300">
                    <div className="pt-6 md:p-8 text-center md:text-left space-y-4">
                        ...
                        <figcaption className="font-medium">
                            ...
                            <div className="text-slate-500 group-hover:text-slate-300 dark:text-slate-200 ">
